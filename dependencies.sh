...
sudo apt-get install -qq locales
...
# for db
sudo apt-get install -qq libtool qt5-default qtbase5-dev libqt5webkit5-dev libclang-5.0-dev libboost-filesystem-dev libboost-python-dev libboost-program-options-dev python-dev llvm-5.0 clang++-5.0 
# for libut
